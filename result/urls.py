...
urlpatterns = [
        ...
        url('drafts/', loggins.post_draft_list, name='post_draft_list'),#post approvals
        #url('post/publish/', loggins.post_publish, name='post_publish'),#review post uncomment for no review
