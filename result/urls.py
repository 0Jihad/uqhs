...
from.import model_views, model_loader, loggins, sign_up
urlpatterns = [
        url(r'^generate/anual/(?P<pk>\d+)/$', model_views.annual_agr, name='anual'),
        url(r'^get_total/(?P<pk>\d+)/$', model_views.subject_total, name='get_total'),
        url('upload_txt/(?P<pk>\d+)/$', model_loader.upload_new_subject_scores, name='upload_txt'),
        ...
        url('tutor_summary/(?P<pk>\d+)/$', model_views.tutor_model_summary, name='tutor_summary'),
        ...
        url('many_subject_updates/(?P<pk>\d+)/$', model_views.many_student_updates, name='many_subject_updates'),
        url('subject_updates/(?P<pk>\d+)/$', model_views.single_student_update, name='subject_updates'),
        url('position_updates/(?P<pk>\d+)/$', model_views.subject_position_updates, name='position_updates'),
        ...
        url(r'^$', loggins.flexbox, name='flexing'),
